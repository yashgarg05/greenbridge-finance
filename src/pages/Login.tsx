...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-[400px] mx-auto z-10 animate-in fade-in zoom-in-95 duration-500">
                <div className="flex flex-col items-center mb-8">
                    <Link to="/" className="flex items-center gap-2 mb-4 hover:opacity-80 transition-opacity">
                        <span className="font-semibold text-lg tracking-tight">GreenBridge</span>
                    </Link>
                    <h1 className="text-2xl font-bold tracking-tight text-center glow-text">Welcome back</h1>
                    <p className="text-sm text-muted-foreground text-center mt-2">
                        Enter your credentials or use <span className="font-mono text-xs bg-muted px-1 rounded">demo@greenbridge.com / demo123</span>
                    </p>
                </div>

                <div className="glass-panel rounded-2xl p-8 space-y-6 shadow-[0_0_50px_-12px_rgba(var(--primary),0.2)]">
                    <div className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                className="bg-background/20 border-white/10 focus:border-primary/50"
                                value={email}
                        ...
                        <Button className="w-full shadow-[0_0_20px_rgba(var(--primary),0.3)] hover:shadow-[0_0_30px_rgba(var(--primary),0.5)] transition-all" onClick={handleLogin}>Sign in</Button>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        <Button variant="outline" className="w-full px-0 bg-white/5 border-white/10 hover:bg-white/10">
